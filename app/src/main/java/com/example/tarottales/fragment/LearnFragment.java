...
public class LearnFragment extends Fragment {
    ...
    void bindingView() {
        ...
        etSearchCard = getView().findViewById(R.id.etSearchCard);
        ...
        etSearchCard.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (searchText.isEmpty()) {
                    // Jika kosong, tampilkan semua card
                    listCard = learnDAO.getListCard();
                } else {
                    // Search card by name, otherName, or keyword
                    listCard = learnDAO.getListCardBySearchName(searchText);
                }
                SetLearnCardToRecyclerView(listCard);
            }
